case SPFD5408A:
	...
	LCD_Write_COM_DATA(0x01,0x0128);
	LCD_Write_COM_DATA(0x02,0x0080);
	...
	LCD_Write_COM_DATA(0x36,0x013F); 
	LCD_Write_COM_DATA(0x37,0x0000); 	
	LCD_Write_COM_DATA(0x38,0x00EF); 
	LCD_Write_COM_DATA(0x39,0x0000); 
	
	LCD_Write_COM_DATA(0x0F,0x03841);
