...
#define UNO_24			29	// SPFD5408A	(8bit)
#define UNO_26			30	// SPFD5408B	(8bit)
#define UNO_22			31	// SPFD5408A	(8bit)
...
*/
		...
		void LCD_Writ_Bus(byte VH, byte VL, byte mode);
		...
		void _fast_fill_8(byte ch, long pix);
